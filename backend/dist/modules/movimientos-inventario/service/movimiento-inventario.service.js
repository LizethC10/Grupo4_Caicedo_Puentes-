...
let MovimientosInventarioService = class MovimientosInventarioService {
    ...
    async findOne(id) {
        ...
        if (!movimiento)
            throw new common_1.NotFoundException('Movimiento de inventario no encontrado');
        return movimiento;
    }
    create(dto) {
...
exports.MovimientosInventarioService = MovimientosInventarioService = __decorate([
    ...
    __metadata("design:paramtypes", [movimientos_inventario_repository_1.MovimientosInventarioRepository])
