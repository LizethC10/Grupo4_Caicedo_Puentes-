...
exports.ProveedoresModule = ProveedoresModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [proveedor_service_1.ProveedorService, proveedor_repository_1.ProveedorRepository],
        exports: [proveedor_service_1.ProveedorService, proveedor_repository_1.ProveedorRepository],
    })
], ProveedoresModule);
